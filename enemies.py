...
class goof(pg.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.timeSinceLastFrame = 0
        self.frame = 0
        self.idle = pg.image.load("enemy/goof/0.png").convert_alpha()
        self.attackAnims = []
        self.deathAnims = []

        for i in range(0, 4):
            self.attackAnims.append(pg.image.load("enemy/goof/attack/" + str(i) + ".png").convert_alpha())

        for i in range(0, 5):
            self.deathAnims.append(pg.image.load("enemy/goof/death/" + str(i) + ".png").convert_alpha())
...
class soldier(pg.sprite.Sprite):
    def __init__(self, x, y, health):
        ...
        self.timeSinceLastFrame = 0
        self.frame = 0
        self.idle = pg.image.load("enemy/soldier/0.png").convert_alpha()
        self.attackAnims = []
        self.deathAnims = []

        for i in range(0, 1):
            self.attackAnims.append(pg.image.load("enemy/soldier/attack/" + str(i) + ".png").convert_alpha())

        #for i in range(0, 5):
        #    self.deathAnims.append(pg.image.load("enemy/soldier/death/" + str(i) + ".png").convert_alpha())
