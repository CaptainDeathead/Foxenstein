...
def main():
    ...
    while True:
        clock.tick(60)
        pg.display.set_caption("Foxenstine!!! FPS: " + str(int(clock.get_fps())) + "    Delta time: " + str(round(dt, 3)) + "    Resolution Scale: " + str(RESOLUTION_SCALE) + "    Resolution: " + str(WIDTH) + "x" + str(HEIGHT) + "    FOV: " + str(FOV) + "    Ray Hits: " + str(int(RAY_HITS)) + "%" + "    Color darken scale: " + str(COLOR_DARKEN_SCALE))
        screen.fill((0,0,0))
